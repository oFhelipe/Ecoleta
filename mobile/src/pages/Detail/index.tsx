...
import { View, Text, StyleSheet, Linking, TouchableOpacity, Image, SafeAreaView, TextInput } from 'react-native'
    ...
    return(
          <SafeAreaView style={{flex:1}}>
            <View style={styles.container}>
              ...
              <TouchableOpacity style={{marginTop:16}} onPress={handleNavigateBack}>
